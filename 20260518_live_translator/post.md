...
```
Duration: 3633s | Iterations: 198 | Passed: 198/198 (100.0%)
Avg score: 9.9/10 | Errors: 0
...
First Response Latency (speech-end to first audio/transcript)
min=0.00  avg=0.04  p50=0.00  p90=0.07  p99=1.20  max=2.24
        =0s:  156 ( 78.8%) ##############################

Turn Complete Latency (speech-end to full translation)
